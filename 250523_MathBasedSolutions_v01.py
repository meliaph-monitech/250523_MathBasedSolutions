# -*- coding: utf-8 -*-
"""250523_MathBasedSolutions_V01.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/120YisV_P8TNEvUyvvOoULgPeIqj9Vtql
"""
...
with st.sidebar:
    ...
    if uploaded_file:
        ...
        filter_column = st.selectbox("Filter column for segmentation", columns, index=columns.index("LO"))
        threshold = st.number_input("LO threshold", value=0.0)
        signal_column = st.selectbox("Signal column for feature extraction", ["NIR", "VIS"])
