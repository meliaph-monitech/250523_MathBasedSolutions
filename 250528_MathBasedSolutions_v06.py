...
if "bead_metadata" in st.session_state and "bead_data" in st.session_state:
    ...
    sensitivity = st.sidebar.slider("Drop Threshold (% below median)", 0.1, 20.0, 10.0, 0.1)
    min_drop_percent = st.sidebar.slider("Min % of dropped points to flag as NOK", 0.1, 20.0, 15.0, 0.1)
